...
//MK added code - copied from drashna's ploopyco/trackball
/* I removed some code relating to h and v since there is no scrollwheel.
 * 
 *
 *
 */
...
*/
//MK removed scroll code because don't have a wheel
/*
...
void keyboard_pre_init_kb(void) {
    ...
    //setPinInput(OPT_ENC1); //MK removed - no scrollwheel
    //setPinInput(OPT_ENC2); //MK removed - no scrollwheel
...
void pointing_device_task(void) {
    ...
    //process_wheel(&mouse_report); // MK removed - no scroll wheel
